...
//== Video Decoder Camera Module Utilizing Libav module of ffmpeg for Decoding
//color video data
...
public:
  ...
  void OutgoingComm(Camera *Camera, const unsigned char *Buffer,
                    long BufferSize) override {}
  virtual bool PostVideoData(Camera *Camera, const unsigned char *Buffer,
                             long BufferSize, const Frame *Frame,
                             int FrameWidth, int FrameHeight,
                             unsigned char *AlignedFrameBuffer,
                             long AlignedFrameBufferSize) override;
  virtual bool PostVideoData(Camera *Camera, const unsigned char *Buffer,
                             long BufferSize, const Frame *Frame,
                             int FrameWidth, int FrameHeight,
                             unsigned char *AlignedFrameBuffer,
